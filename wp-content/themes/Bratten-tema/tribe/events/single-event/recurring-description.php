...
$recurrence_data = get_post_meta( $post_id, 'content', true );
$recurrence_description = $recurrence_data['content'] ? $recurrence_data['content'] : esc_html__( 'Recurring event', 'the-events-calendar' );
?>
